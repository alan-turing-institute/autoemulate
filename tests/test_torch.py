...
def test_nn_torch_module_initialisation():
    for module in ("MultiLayerPerceptron", "RadialBasisFunctionsNetwork"):
...
def test_nn_torch_pred_exists():
    ...
    nn_torch_model = NeuralNetTorch(module="MultiLayerPerceptron")
...
def test_nn_torch_mismatch_shape():
    ...
    nn_torch_model = NeuralNetTorch(
        module="MultiLayerPerceptron", module__input_size=5, module__output_size=1
    )
