...
#SBATCH --job-name turbulent_radiative_layer_2D_download
...
python $RUN_PATH/run_the_well_experiment.py --config $RUN_PATH/configs/advection_diffusion_generated.yaml
