...
class EvidenceComputation(TorchDeviceMixin):
    ...
    Notes
    -----
    The Harmonic method learns a normalizing flow to approximate the normalized
    posterior distribution, then uses this learned distribution to compute importance
