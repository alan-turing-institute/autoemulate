...
class BetaMLP(MLP):
    ...
    def __init__(
        ...
        **scheduler_kwargs: dict
        ...
        MLP.__init__(
            ...
            dropout_prob,
            lr,
            2,  # params_size=2 for Beta distribution
            random_seed,
            device,
            **scheduler_kwargs,
        )
    ...
    def forward(self, x):
        ...
        EPS = 1e-6
        output = self.nn(x)
        conc1 = F.softplus(output[..., :1]) + EPS
        conc0 = F.softplus(output[..., 1:]) + EPS
        return Beta(concentration0=conc0, concentration1=conc1)
    ...
    def predict_mean_and_variance(
        ...
        with torch.set_grad_enabled(with_grad):
            ...
            assert isinstance(beta_dist, Beta)
