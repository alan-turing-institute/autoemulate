...
class AutoEmulate(ConversionMixin, TorchDeviceMixin):
    def __init__(  # noqa: PLR0913
        ...
        transforms_list: list[list[AutoEmulateTransform]] | None = None,
        target_transforms_list: list[list[AutoEmulateTransform]] | None = None,
        ...
        self.target_transforms_list = target_transforms_list or [[]]
    ...
    def log_compare(  # noqa: PLR0913
        ...
        msg = (
            ...
            f"Target Transforms: {target_transforms}",
    ...
    def compare(
        ...
        models_evaluated = {}
        for transforms in self.transforms_list:
            for target_transforms in self.target_transforms_list:
                for model_cls in self.models:
                    ...
                    models_evaluated[
                        (
                            ...
                            "-".join(str(t) for t in transforms),
                            "-".join(str(t) for t in target_transforms),
