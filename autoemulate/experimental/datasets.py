...
def fetch_data(
    ...
    dataset: str
        ...
        - **reactiondiffusion1**: Reaction-diffusion system simulated data. Spatial
                        snapshots in correspondence for different values of reaction and
                        diffusion parameters. (50 snapshots in corresponence of 50
                        different parameter sets at time T=10).
    split: bool
    ...
    -------
    tuple[TensorLike, TensorLike]
        Tensors of simulation parameters / inputs and simulation outputs.
    """
